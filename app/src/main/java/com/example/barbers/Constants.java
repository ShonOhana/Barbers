...
public class Constants {
    ...
    public static final String BARBERPATH = "barbers";
    public static final String CLIENTPATH = "clients";



    public static final int[] BUTTONS = {R.id.sunday_btn_700,R.id.sunday_btn_730,R.id.sunday_btn_800,R.id.sunday_btn_830,R.id.sunday_btn_900,R.id.sunday_btn_930,R.id.sunday_btn_1000,R.id.sunday_btn_1030,R.id.sunday_btn_1100,
...
//            R.id.monday_btn_700, R.id.monday_btn_730, R.id.monday_btn_800, R.id.monday_btn_830, R.id.monday_btn_900, R.id.monday_btn_930, R.id.monday_btn_1000, R.id.monday_btn_1030, R.id.sunday_btn_11100};
    ...
    static class CalanderConstants {
